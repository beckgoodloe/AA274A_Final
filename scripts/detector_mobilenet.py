...
class Detector:
    ...
    def __init__(self):
        ...
        #rospy.Subscriber('/camera/image_raw', Image, self.camera_callback, buff_size=2**24)
        #rospy.Subscriber('/camera/image/compressed', CompressedImage, self.compressed_camera_callback, buff_size=2**24)
